...
| Concern                             | Where                                                                                                                                                                   |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Contract schema                     | `contracts/component.schema.json` + `contracts/react-binding.schema.json` — split and moved by [ADR 0002](./0002-the-contract-specifies-and-the-gate-asserts-parity.md) |
