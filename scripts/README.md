...
| [`verify-parity.mjs`](./verify-parity.mjs) | `pnpm verify:parity`                      | **gate**  | Three backends have not drifted: duplicated behaviour cores identical, bindings agree on the root element |
