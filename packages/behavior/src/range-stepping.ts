// The pure core of range stepping: no framework, no DOM, no side effects.
//
// Split from the framework bindings for the same reason `linear-navigation.ts` is: everything below is a
