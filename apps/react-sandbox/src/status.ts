...
export const CROSS_CUTTING = [
  ...
  'Eight conformance cases across two primitives remain deferred in the node tests. The Playwright lane now checks generated-component regressions, but these cases still need dedicated browser coverage (#15), including the geometry test for a press inside the Dialog.',
